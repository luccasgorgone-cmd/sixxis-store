...
export default function ProdutoForm({ initialData, produtoId, mode }: ProdutoFormProps) {
  ...
  const [form, setForm] = useState<ProdutoFormData>({
    ...
    custoProduto: initialData?.custoProduto ?? '',
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const body = {
      ...
      custoProduto: form.custoProduto ? Number(form.custoProduto) : null,
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Custo de aquisição/fábrica, não preço de venda. Usado no relatório de Margem.
                  O cliente nunca vê. Em branco = sem custo informado (o pedido fica fora do lucro).
                </p>
              </div>
              <div>
