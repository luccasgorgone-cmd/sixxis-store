...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2">
      {/* Tooltip */}
      {hovered && (
        <div className="bg-[#0a0a0a] text-white text-sm font-medium px-3 py-1.5 rounded-lg shadow-lg whitespace-nowrap">
          Fale conosco
        </div>
      )}
      ...
      <a
        ...
        style={{ background: hovered ? '#128C7E' : '#25D366', transition: 'background 0.2s, transform 0.2s' }}
