...
const EMPTY: Omit<Banner, 'id' | 'ordem'> = {
  imagem: '', titulo: '', subtitulo: '', link: '', ativo: true, tempoCads: 5,
}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div
                ...
                className={`border-2 border-dashed rounded-xl h-48 cursor-pointer flex items-center justify-center overflow-hidden relative transition ${
