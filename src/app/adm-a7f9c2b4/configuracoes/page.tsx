...
export default function ConfiguracoesPage() {
  ...
  return (
    <>
      ...
      <a
        href="/adm-a7f9c2b4/luna"
        className="mb-6 flex items-center justify-between gap-4 bg-[#e8f8f7] border border-[#3cbfb3]/30 rounded-2xl px-5 py-4 hover:bg-[#d8f3f0] transition group"
      >
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-white border border-[#3cbfb3]/30 flex items-center justify-center shrink-0">
            <Bot className="w-5 h-5 text-[#3cbfb3]" />
          </div>
          <div>
            <p className="text-sm font-bold text-[#0f2e2b]">Configuração da Luna foi movida</p>
            <p className="text-xs text-[#1a4f4a]/70 mt-0.5">
              Persona, prompt, follow-ups e métricas estão na página dedicada da Luna.
            </p>
          </div>
        </div>
        <span className="flex items-center gap-1.5 text-sm font-bold text-[#3cbfb3] group-hover:gap-2.5 transition-all">
          Abrir Luna <ExternalLink className="w-4 h-4" />
        </span>
      </a>
