...
export default function AdminDashboard() {
  ...
  const CARDS = [
    { label:'Receita Total',      valor:m.receita||0,          moeda:true,  variacao:var_.receita,    Icon:TrendingUp,  bg:'#dcfce7', fg:'#16a34a', href:'/admin/pedidos', sub:`${m.totalPedidos||0} pedidos` },
    { label:'Ticket Médio',       valor:m.ticketMedio||0,      moeda:true,  variacao:var_.ticketMedio,Icon:BarChart3,   bg:'#fef9c3', fg:'#ca8a04' },
    { label:'Total de Pedidos',   valor:m.totalPedidos||0,     moeda:false, variacao:var_.pedidos,    Icon:ShoppingBag, bg:'#dbeafe', fg:'#2563eb', href:'/admin/pedidos' },
    { label:'Clientes',           valor:m.totalClientes||0,    moeda:false, variacao:var_.clientes,   Icon:Users,       bg:'#e8f8f7', fg:DARK, href:'/admin/clientes', sub:`${dados?.clientesPerfil?.novos||0} novos` },
    { label:'Produtos Ativos',    valor:m.produtosAtivos||0,   moeda:false, Icon:Package,  bg:'#e0e7ff', fg:'#4f46e5', href:'/admin/produtos' },
    { label:'Pedidos Pendentes',  valor:m.pedidosPendentes||0, moeda:false, Icon:Clock,    bg:'#fef3c7', fg:'#d97706', href:'/admin/pedidos?status=PENDENTE' },
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-[1600px] mx-auto">
      ...
      {(dados?.estoqueCritico?.length||0) > 0 && (
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <Link href="/admin/produtos" className="ml-auto text-xs text-amber-600 hover:underline flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/admin/produtos" className="text-xs text-[#3cbfb3] hover:underline flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/pedidos" className="text-xs text-[#3cbfb3] hover:underline flex items-center gap-1">
              Ver todos <ChevronRight size={11} />
            </Link>
          </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { href:'/admin/produtos/novo', label:'Novo Produto',   cor:TIFFANY    },
            { href:'/admin/pedidos',       label:'Ver Pedidos',    cor:'#2563eb'  },
            { href:'/admin/cupons',        label:'Criar Cupom',    cor:'#7c3aed'  },
            { href:'/admin/configuracoes', label:'Configurações',  cor:DARK       },
          ].map((a,i) => (
