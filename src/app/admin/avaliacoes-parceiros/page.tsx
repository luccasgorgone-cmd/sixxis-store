    ...
    <div className="p-4 sm:p-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div className="min-w-0">
          <h1 className="text-xl md:text-2xl font-extrabold text-gray-900">Avaliações de Parceiros</h1>
        ...
        <button
          ...
          className="w-full md:w-auto flex items-center justify-center gap-2 bg-[#3cbfb3] hover:bg-[#2a9d8f] text-white font-bold px-4 py-2.5 rounded-xl text-sm transition shadow-md">
