...
const regraSchema = z
  .object({
    ...
    prazoNormalMin: prazoField.optional(),
    prazoNormalMax: prazoField.optional(),
    precoExpresso: precoField.optional(),
    prazoExpressoMin: prazoField.optional(),
    ...
    ...regras.map((r) =>
      prisma.freteRegra.upsert({
        ...
        update: {
          ...
          prazoNormalMin: r.prazoNormalMin,
          prazoNormalMax: r.prazoNormalMax,
          precoExpresso: r.precoExpresso,
          prazoExpressoMin: r.prazoExpressoMin,
