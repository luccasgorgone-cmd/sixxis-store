...
export const NIVEIS_CONFIG: Record<string, {
  ...
  Cristal: {
    ...
    cashbackPct: 0.02, minGasto: 0, maxGasto: 10000, proximoNivel: 'Topázio',
  },
  Topázio: {
    ...
    cashbackPct: 0.03, minGasto: 10000, maxGasto: 20000, proximoNivel: 'Safira',
  },
  Safira: {
    ...
    cashbackPct: 0.04, minGasto: 20000, maxGasto: 30000, proximoNivel: 'Diamante',
  },
  Diamante: {
    ...
    cashbackPct: 0.05, minGasto: 30000, maxGasto: 40000, proximoNivel: 'Esmeralda',
  },
  Esmeralda: {
    ...
    cashbackPct: 0.06, minGasto: 40000, maxGasto: Infinity, proximoNivel: null,
  },
}
...
export function calcularNivel(totalGasto: number): string {
  // Faixas de R$10k sem buracos; o limite superior pertence ao nível inferior
  // (ex.: exatamente 10.000 = Cristal; 10.000,01 = Topázio).
  if (totalGasto > 40000) return 'Esmeralda'
  if (totalGasto > 30000) return 'Diamante'
  if (totalGasto > 20000) return 'Safira'
  if (totalGasto > 10000) return 'Topázio'
  return 'Cristal'
}
