...
export const NIVEIS_CONFIG: Record<string, {
  ...
  Cristal: {
    ...
    cashbackPct: 0.02, minGasto: 0, maxGasto: 5000, proximoNivel: 'Topázio',
  },
  Topázio: {
    ...
    cashbackPct: 0.03, minGasto: 5000, maxGasto: 10000, proximoNivel: 'Safira',
  },
  Safira: {
    ...
    cashbackPct: 0.04, minGasto: 10000, maxGasto: 15000, proximoNivel: 'Diamante',
  },
  Diamante: {
    ...
    cashbackPct: 0.05, minGasto: 15000, maxGasto: 20000, proximoNivel: 'Esmeralda',
  },
  Esmeralda: {
    ...
    cashbackPct: 0.06, minGasto: 20000, maxGasto: Infinity, proximoNivel: null,
  },
}
...
export function calcularNivel(totalGasto: number): string {
  ...
  if (totalGasto > 20000) return 'Esmeralda'
  if (totalGasto > 15000) return 'Diamante'
  if (totalGasto > 10000) return 'Safira'
  if (totalGasto > 5000)  return 'Topázio'
  return 'Cristal'
}
