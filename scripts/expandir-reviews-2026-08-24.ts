...
const CARDIO: Nova[] = [
  ...
  { nomeAutor: 'Ricardo F.', nota: 5, titulo: 'Chegou embalada com capricho', comentario: 'A Sixxis Cardio veio numa caixa reforçada, nada amassado apesar do peso. Consegui abrir e conferir as peças sem susto, tudo dentro do esperado.' },
  { nomeAutor: 'Elenice M.', nota: 4, titulo: 'Guidão trava, mas exige um pouco de força pra ajustar', comentario: 'O guidão ajustável da Sixxis Cardio trava firme depois de regulado, só que preciso fazer uma certa força na trava pra soltar e reajustar. Uma vez travado, fica seguro.' },
  { nomeAutor: 'Tarcísio V.', nota: 5, titulo: 'Volante de 8kg dá inércia boa pro treino', comentario: 'O volante de inércia de 8kg da Sixxis Cardio dá aquela sensação de pedalada contínua, sem parar de repente quando solto o pedal. Faz diferença no treino.' },
  { nomeAutor: 'Grazi P.', nota: 5, titulo: 'Freio de emergência dá segurança', comentario: 'Uso o freio de emergência sempre que preciso parar rápido durante o treino mais puxado. A Sixxis Cardio responde na hora, sem susto.' },
  { nomeAutor: 'Wallace L.', nota: 4, titulo: 'Pilha não vem na caixa, um detalhe chato', comentario: 'O painel da Sixxis Cardio usa 2 pilhas AAA que não vêm inclusas, tive que comprar separado pra usar no mesmo dia. Fora isso, o painel mostra tudo que preciso.' },
  { nomeAutor: 'Ilma R.', nota: 5, titulo: 'Carenagem protege meu filho pequeno da correia', comentario: 'Tenho um filho pequeno em casa e a carenagem da Sixxis Cardio deixa a correia bem protegida, sem risco dele colocar a mão sem querer.' },
  { nomeAutor: 'Douglas B.', nota: 3, titulo: 'Achei a altura máxima meio justa pra mim', comentario: 'Tenho quase 1,80m, no limite da altura máxima recomendada pela ficha da Sixxis Cardio, e senti que o ajuste do guidão e do assento ficou meio no limite pra minha altura. Funciona, mas sem muita folga.' },
  { nomeAutor: 'Sônia T.', nota: 5, titulo: 'Aguenta meu peso numa boa', comentario: 'Peso perto de 100kg e a Sixxis Cardio aguenta numa boa, dentro do limite de 120kg da ficha técnica. Estrutura firme, sem sinal de fraqueza.' },
  { nomeAutor: 'Ederson G.', nota: 5, titulo: 'Odômetro ajuda a acompanhar evolução', comentario: 'O painel da Sixxis Cardio mostra velocidade, tempo, distância e calorias, e o odômetro ajuda bastante a acompanhar quanto já rodei desde que comprei. Motivação extra pro treino.' },
  ...
  { nomeAutor: 'Fabrício Q.', nota: 5, titulo: 'Estrutura de aço não balança nem de pé', comentario: 'Pedalo de pé nos treinos mais intensos e a estrutura de aço da Sixxis Cardio não balança nem sacode. Sensação de firmeza total.' },
  { nomeAutor: 'Neuza H.', nota: 5, titulo: 'Sem bluetooth, mas não fez falta pra mim', comentario: 'Sabia que a Sixxis Cardio não tem bluetooth antes de comprar e realmente não senti falta, uso só o painel mesmo pra acompanhar o treino. Preço compensa a ausência.' },
  { nomeAutor: 'Adalberto K.', nota: 5, titulo: 'Amortecedores do assento seguram bem', comentario: 'O assento ergonômico ajustável da Sixxis Cardio tem uns amortecedores que ajudam bastante nos treinos mais longos, não fico dolorido depois.' },
  ...
  { nomeAutor: 'Valdir C.', nota: 5, titulo: 'Medidas cabem até em apartamento pequeno', comentario: 'Meu apartamento é pequeno e a Sixxis Cardio, com suas medidas montada de 88x46x113cm, cabe bem num cantinho da sala sem atrapalhar.' },
  { nomeAutor: 'Gislaine D.', nota: 4, titulo: 'Dá pra ouvir a correia de perto, nada absurdo', comentario: 'A transmissão por correia da Sixxis Cardio é bem mais silenciosa que corrente, mas de bem perto dá pra ouvir um leve som. De longe nem percebo.' },
  { nomeAutor: 'Osmar R.', nota: 5, titulo: 'Pedalando todo dia sem enjoar', comentario: 'Já é rotina pedalar na Sixxis Cardio todo dia de manhã. A resistência mecânica dá pra variar o treino e não enjoa fácil.' },
...
const LIFE: Nova[] = [
  ...
  { nomeAutor: 'Marcelo R.', nota: 5, titulo: '10 níveis dão pra variar bastante o treino', comentario: 'Os 10 níveis de resistência da Sixxis Life dão liberdade pra fazer treino leve de recuperação ou puxado de intervalo no mesmo dia, só ajustando na hora.' },
  { nomeAutor: 'Vanuza S.', nota: 5, titulo: 'Sensor cardíaco bateu com meu relógio', comentario: 'Conferi o sensor cardíaco integrado da Sixxis Life com meu relógio esportivo e os números bateram certinho. Confio no dado que aparece no painel.' },
  { nomeAutor: 'Célio T.', nota: 5, titulo: 'App reconhece a bike rápido', comentario: 'Testei os 3 aplicativos exclusivos da Sixxis Life e o reconhecimento foi rápido, sem ficar tentando conectar. Acompanho o treino direto pelo celular.' },
  { nomeAutor: 'Adélia B.', nota: 5, titulo: 'Emagreci pedalando quase todo dia', comentario: 'Uso a Sixxis Life quase todo dia há uns meses e realmente senti a queima de calorias que prometem, cheguei a perder alguns quilos combinando com a dieta.' },
  ...
  { nomeAutor: 'Miriam D.', nota: 5, titulo: 'Aguenta meu peso sem susto', comentario: 'Peso perto de 110kg e a Sixxis Life aguenta numa boa, dentro do limite de 120kg. Estrutura de aço não dá sinal de fraqueza.' },
  { nomeAutor: 'Nilson P.', nota: 5, titulo: 'Cabe pessoa alta, uso com 1,88m', comentario: 'Tenho 1,88m e estava com receio de não caber direito, mas a Sixxis Life ajusta até a altura máxima de 190cm sem problema. Guidão e assento com bastante curso.' },
  ...
  { nomeAutor: 'Ivanildo G.', nota: 5, titulo: 'Painel LED mostra tudo que preciso', comentario: 'O painel LED da Sixxis Life é simples mas mostra velocidade, distância, frequência cardíaca e calorias, que é exatamente o que acompanho no treino.' },
  { nomeAutor: 'Cleuza N.', nota: 5, titulo: 'Pedal com tira segura bem o pé', comentario: 'As tiras de fixação dos pedais da Sixxis Life seguram bem o pé mesmo nos treinos mais intensos, sem escorregar.' },
  { nomeAutor: 'Wagner Q.', nota: 5, titulo: 'Guidão ajusta rápido', comentario: 'O guidão ajustável da Sixxis Life é rápido de regular, encontro minha posição em segundos antes de começar o treino.' },
  { nomeAutor: 'Rosane K.', nota: 5, titulo: 'Estrutura de aço não balança', comentario: 'Mesmo nos treinos de pé, a estrutura de aço de alta qualidade da Sixxis Life fica firme, sem balançar.' },
  { nomeAutor: 'Toninho C.', nota: 3, titulo: 'Montagem levou um tempinho, mas o manual ajuda', comentario: 'A montagem da Sixxis Life demorou mais do que eu esperava, quase uma hora, mas o manual é bem detalhado e consegui sozinho sem complicação.' },
  { nomeAutor: 'Delma W.', nota: 5, titulo: 'Assento ajustável resolveu meu desconforto', comentario: 'Tinha desconforto com bike de academia genérica, mas o assento ergonômico ajustável da Sixxis Life resolveu, consigo treinar bem mais tempo sem incômodo.' },
  { nomeAutor: 'Nívea R.', nota: 5, titulo: 'Silenciosa o suficiente pra treinar de madrugada', comentario: 'Pedalo antes das 6h sem acordar ninguém em casa. A Sixxis Life é silenciosa o suficiente pra isso.' },
...
const M45: Nova[] = [
  ...
  { nomeAutor: 'Osvaldo T.', nota: 5, titulo: 'Uso na oficina e os funcionários agradeceram', comentario: 'Coloquei o M45 Trend na oficina onde trabalho e o ambiente ficou muito mais agradável no calor. Roda o expediente inteiro sem dar problema.' },
  ...
  { nomeAutor: 'Genivaldo R.', nota: 5, titulo: 'Dei de presente pro meu pai e ele adorou', comentario: 'Meu pai sofria bastante com o calor no quarto dele. O M45 Trend resolveu e ele não teve dificuldade nenhuma pra usar no dia a dia, é bem simples.' },
  { nomeAutor: 'Ivone C.', nota: 5, titulo: '15kg, mas dá pra mover sozinho', comentario: 'Pela ficha técnica achei que ia ser difícil de deslocar, mas na prática consigo levar o M45 Trend da sala pro quarto sozinho sem esforço.' },
  { nomeAutor: 'Anselmo D.', nota: 5, titulo: 'Painel evaporativo fácil de limpar', comentario: 'O painel evaporativo de 4cm do M45 Trend é simples de remover pra lavar. Não fica com cheiro de mofo depois de um tempo, diferente de climatizador antigo que já tive.' },
  { nomeAutor: 'Adelaide F.', nota: 5, titulo: 'Segurou o calorão do verão aqui em casa', comentario: 'Aqui bate fácil os 38 graus no verão e o M45 Trend deu conta bem do meu quarto. Uso praticamente o dia todo e a diferença de temperatura é bem perceptível assim que entra no ambiente.' },
  { nomeAutor: 'Wanderley S.', nota: 4, titulo: 'Ruído baixo, mas dá pra notar de perto', comentario: 'O M45 Trend cumpre o que promete de silêncio, mas bem de perto dá pra notar um zumbido do motor. De uma certa distância nem percebo mais.' },
  { nomeAutor: 'Iracema G.', nota: 4, titulo: 'Caixa veio com um amasso, produto ok', comentario: 'A caixa do M45 Trend chegou com um canto meio amassado no transporte, mas por dentro o climatizador estava intacto e ligou sem problema.' },
  { nomeAutor: 'Belmiro N.', nota: 3, titulo: 'Bom, mas pro meu galpão não foi suficiente', comentario: 'O M45 Trend funciona bem dentro da cobertura indicada de até 45m². No meu galpão, que é bem maior que isso, o refresco ficou bem limitado. Pra ambiente residencial deve ser ótimo.' },
  { nomeAutor: 'Cecília Q.', nota: 5, titulo: 'Não preciso ficar reabastecendo toda hora', comentario: 'O tanque de 45 litros do M45 Trend segura bem, encho de manhã e não preciso mexer de novo até a noite. Bem prático pro dia a dia.' },
  { nomeAutor: 'Amaro H.', nota: 5, titulo: 'Sala inteira ficou fresca', comentario: 'Minha sala tem uns 30m², dentro da cobertura do M45 Trend, e ele refresca de ponta a ponta. O alcance do fluxo de ar ajuda bastante a levar o vento mais longe.' },
  ...
  { nomeAutor: 'Valter B.', nota: 4, titulo: 'Só 3 velocidades, mas já dá pra variar bem', comentario: 'Gostaria de mais opções de velocidade, mas as 3 do M45 Trend já dão uma boa margem entre o modo mais suave e o mais forte. Não senti falta no dia a dia.' },
  { nomeAutor: 'Neide M.', nota: 5, titulo: 'Oscilação horizontal automática ajuda muito', comentario: 'A oscilação horizontal automática do M45 Trend distribui o ar pro quarto todo sem eu precisar ficar ajustando. Facilita bastante.' },
  { nomeAutor: 'Josias L.', nota: 4, titulo: 'Oscilação vertical é manual, mas funciona bem', comentario: 'A oscilação vertical do M45 Trend é ajustada na mão, não é automática, mas depois de regular do jeito que eu gosto nem mexo mais. Só um detalhe pra quem já sabia antes de comprar.' },
  { nomeAutor: 'Aparecida R.', nota: 3, titulo: 'Controle é manual, sem remoto — bom saber antes de comprar', comentario: 'O M45 Trend não vem com controle remoto, é tudo no painel mesmo. Não é um problema porque fica do lado da cama, mas quem espera controle remoto vai se decepcionar.' },
  { nomeAutor: 'Sebastião P.', nota: 5, titulo: 'Recomendo pra quem tem alergia', comentario: 'Minha esposa tem rinite e o ar mais úmido do M45 Trend ajudou bastante a reduzir as crises comparado ao ar-condicionado seco que tínhamos antes.' },
